//! Example of optimizing the Rosenbrock function with genetic algorithm.
//!
//! y = f(x), where x = (x0, x1, ..., xi,... xn).
//! Global minimum is x' = (1.0, 1.0, ...) for any xi lying in [-500.0; 500.0].
//! f(x') = 0
//!
//! # Terms
...
fn print_statistics(
    ...
    let valid_answer = vec![1.0; chromo_count];
    let delta = vec![1e-2; chromo_count];
