//! Example of optimizing the Rosenbrock function with particle swarm algorithm.
use std::fs::File;
use std::io;
use std::sync::mpsc;
use std::thread;
