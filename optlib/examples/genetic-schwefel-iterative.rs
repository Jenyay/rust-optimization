...
use optlib::{GoalFromFunction, IterativeOptimizer, Optimizer};
use optlib_testfunc;
...
fn main() {
    ...
    let stop_checker_1 = Box::new(stopchecker::MaxIterations::new(100));
    let stop_checker_2 = Box::new(stopchecker::MaxIterations::new(500));
